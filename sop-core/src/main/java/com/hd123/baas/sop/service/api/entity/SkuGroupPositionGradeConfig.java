...
@Setter
@Getter
public class SkuGroupPositionGradeConfig {
  /**
   * uuid
   */
  private int uuid;
   ...
   * 价格定位ID
   */
  private int pricePositionId;
  /**
   * 价格级集合
   */
  private String priceGradeJson;

  @QueryEntity(SkuGroupPositionGradeConfig.class)
  public static class Queries extends QueryFactors.Entity {

    private static final String PREFIX = SkuGroupPositionGradeConfig.class.getName() + "::";
    @QueryField
