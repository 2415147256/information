...
@Getter
@Setter
public class PVShopTaskSummary extends PEntity {
  @TableName
  public static final String TABLE_NAME = "v_shop_task_summary";
  public static final String TABLE_ALIAS = "_v_shop_task_summary";
  ...
  public static final String FINISHED_LOG_COUNT = "finished_log_count";

  public static final String LOG_TOTAL_COUNT = "log_total_count";
