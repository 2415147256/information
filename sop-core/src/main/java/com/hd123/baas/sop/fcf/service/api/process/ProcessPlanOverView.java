...
@Setter
@ApiModel("智能制作计划单概览")
public class ProcessPlanOverView extends TenantEntity {
  ...
  private List<FreshMealTime> mealTimes = new ArrayList<>();

  @ApiModelProperty
  private List<ProcessPlanCategoryOverView> overViews = new ArrayList<>();
}
