 ...
 */
@Data
public class RsInvXFApply implements Serializable {
  private static final long serialVersionUID = 8767319537972039450L;
  ...
  @NotBlank
  private String cls;
  @ApiModelProperty(value = "来源单号", example = "9999202002110001", required = true)
  @NotBlank
  private String srcNum;
  @ApiModelProperty(value = "来源类别", example = "店务", required = true)
  @Length(max = 16)
  @NotBlank
  ...
  private List<RsInvXFApplyReqLine> lines = new ArrayList<>();
