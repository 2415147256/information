...
@Getter
@Setter
public class RsSkuParameter implements Serializable {

  private static final long serialVersionUID = 2296288309611984169L;

  public RsSkuParameter() {
    super();
  }

  public RsSkuParameter(String name, String value) {
    this();
    this.name = name;
    this.value = value;
  }
  ...
  public boolean equals(Object obj) {
    ...
    RsSkuParameter other = (RsSkuParameter) obj;
    if (name == null) {
      if (other.name != null) {
        return false;
      }
