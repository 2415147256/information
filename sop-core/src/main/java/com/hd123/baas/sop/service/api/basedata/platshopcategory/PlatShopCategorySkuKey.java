...
@Setter
@ApiModel
public class PlatShopCategorySkuKey {

  private String platShopCategoryId;
  private String shopId;
  private List<String> skuIds = new ArrayList<String>();

  public PlatShopCategorySkuKey() {
    super();
  }

  public PlatShopCategorySkuKey(String platShopCategoryId, String shopId, List<String> skuIds) {
    super();
