...
public class FeedbackBase extends StandardEntity {
  ...
  @ApiModelProperty(value = "等级ID", example = "1001", required = true)
  @NotBlank
  private String gradeId;
  @ApiModelProperty(value = "等级名称", example = "一般", required = true)
  @NotBlank
  ...
  @ApiModelProperty(value = "审批策略", required = false)
  private String checkPolicy = FeedbackConfig.DEFAULT_POLICY;
